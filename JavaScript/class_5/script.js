...
// function = set of lines or block of codes which is used to perfotm a perticular task

// Advatages of function
// readablity = easy to understand
// reusablity = write once and anytime anywhere 
// better performence = due to less no of lines our codes will be fast
...
// 4 . callback function
// 5 . IIFE function
// 6 . annonymous function

function increment(salary,bonous){
   return salary+ bonous;
}
let incrementBonous = increment(1000 ,50);
let inicialSalary = 5000;
let finalSalary = incrementBonous + inicialSalary;
